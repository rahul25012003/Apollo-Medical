...
export async function seedIfpc2026(prisma: PrismaClient) {
  ...
  await prisma.tenant.update({
    ...
    data: {
      ...
      faqs: [
        { id: 1, category: "Venue", question: "When and where is the conference being held?", answer: "IFPC 2026 will be held from 2–5 November 2026 at the NIMHANS Convention Centre, Hosur Road, Bengaluru, India." },
        { id: 2, category: "General", question: "Who is organising the conference?", answer: "The conference is co-hosted by NIMHANS, Bengaluru and RANZCP (the Royal Australian and New Zealand College of Psychiatrists)." },
        { id: 3, category: "General", question: "What is the theme of IFPC 2026?", answer: "The theme is 'Bridging the Gap,' focused on strengthening the interface between research, clinical practice, law, and rehabilitation in forensic psychiatry, and on deepening collaboration between Australia, New Zealand, and India." },
        { id: 4, category: "Registration", question: "Who should attend?", answer: "The conference is designed for psychiatry trainees, psychiatrists, forensic medicine professionals, mental health professionals, and law professionals." },
        { id: 5, category: "Registration", question: "How do I register, and what does registration include?", answer: "Registration is completed through the official registration portal. It includes access to all workshops and scientific sessions, daily lunch, snacks and refreshments, the two-day cultural programme, and two official conference dinners. Accommodation is not included." },
        { id: 6, category: "Registration", question: "Are there different registration fees for Indian and international delegates?", answer: "Yes. Separate early-bird and standard fees apply for Indian Delegates, Indian Trainee Delegates, International Delegates, and International Trainee Delegates. Full fee details are available on the Registration page." },
        { id: 8, category: "Registration", question: "Do presenters need to register separately?", answer: "Yes. All presenters must register for the conference for their presentation to be included in the programme. Accepting an abstract does not include travel, accommodation, registration costs, or a presenter fee." },
        { id: 9, category: "Certificates", question: "Are CME or credit points available?", answer: "KMC credit points are available for Indian doctors under the NMC Act, 2019." },
        { id: 10, category: "Workshops", question: "What optional activities are available to delegates?", answer: "Registered delegates can enquire at the Registration Desk about the guided NIMHANS campus tour and the complimentary daily morning yoga sessions — both can also be signed up for from your dashboard." },
        { id: 11, category: "Venue", question: "What is the weather like in November, and what should I pack?", answer: "Bengaluru is pleasant in November, with daytime temperatures of 18–25°C. A light jacket is recommended for cooler evenings, along with comfortable walking shoes and a compact umbrella for occasional showers." },
        { id: 12, category: "Contact", question: "Whom do I contact for further questions?", answer: "For general queries, email fpnimhans@gmail.com or contact the Conference Manager, Dr. Madhu Sudhan R M, at dr.madhusudhanrm@gmail.com / +91 7760504068." },
        { id: 13, category: "Accommodation", question: "Is accommodation included, and how do I book a hotel?", answer: "Accommodation is not included in the registration fee. A list of nearby hotels across budget, mid-range and premium tiers is available in your dashboard under Accommodation, where you can also record your sharing preference (single, two-sharing or three-sharing) and travel dates — this records your intent for the organising team, not a live booking. Contact the hotel directly to confirm availability and rates." },
        { id: 14, category: "Transportation", question: "How do I get to the venue?", answer: "The NIMHANS Convention Centre is on Hosur Road, Bengaluru, well connected by taxi and ride-hailing apps from Kempegowda International Airport and the city's railway stations. See the Venue & Travel page for the exact address and a map link." },
        { id: 15, category: "Food", question: "Can I specify a food preference?", answer: "Yes. You can set your Vegetarian / Non-Vegetarian preference during registration, or update it afterwards from your dashboard, so the catering count reflects your choice." },
        { id: 16, category: "Workshops", question: "How do I sign up for workshops and sessions?", answer: "Browse the Scientific Programme in your dashboard and tap \"I'd like to attend\" on any workshop or seminar with limited seats. Everything you've signed up for is listed under My Interests." },
        { id: 17, category: "Certificates", question: "How do I get my certificate of attendance?", answer: "Your certificate of attendance is issued automatically once your registration is confirmed, and any presentation certificate once your abstract is accepted. Download or print both from My Certificates in your dashboard." },
      ],
      researchItems: [],
